...
import { FaHeartbeat, FaHospital, FaUserMd, FaAmbulance, FaFireExtinguisher, FaShieldAlt } from 'react-icons/fa';
  ...
  return (
    <div className="py-12 px-4 md:px-16 bg-base-100">
      ...
      <div className="text-center mt-8">
        <Link to="/AllServices" className="btn btn-outline btn-primary">
          সব সেবা দেখুন
        </Link>
      </div>
    </div>
