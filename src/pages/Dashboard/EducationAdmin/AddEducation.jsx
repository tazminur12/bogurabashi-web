...
const AddEducation = () => {
  ...
  const IMGBB_API_KEY = import.meta.env.VITE_IMGBB_API_KEY; // You need to replace this with your actual ImgBB API key
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axiosSecure.post('/educations', instituteData);
      
      if (res.data.insertedId) {
        Swal.fire({
          title: 'সফল!',
          text: 'শিক্ষা প্রতিষ্ঠান সফলভাবে যোগ করা হয়েছে',
          icon: 'success',
      ...
      console.error('Error adding education institute:', error);
      Swal.fire('ত্রুটি', 'শিক্ষা প্রতিষ্ঠান যোগ করা যায়নি', 'error');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-2">নতুন শিক্ষা প্রতিষ্ঠান যোগ করুন</h1>
          <p className="text-gray-600 text-lg">বগুড়া জেলার শিক্ষা প্রতিষ্ঠানের তথ্য যোগ করুন</p>
        </div>
