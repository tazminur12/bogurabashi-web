...
import { FaAmbulance, FaMapMarkerAlt, FaPhone, FaExclamationTriangle, FaPlus, FaTimes, FaUpload, FaCheck, FaSpinner, FaEdit, FaSave } from "react-icons/fa";
...
const EditAmbulance = () => {
  ...
  // Fetch existing ambulance data
  useEffect(() => {
    const fetchAmbulance = async () => {
      try {
        setFetching(true);
        const res = await axiosSecure.get(`/ambulances/${id}`);
        if (res.data) {
          setFormData(res.data);
        }
      } catch (error) {
        console.error("Error fetching ambulance:", error);
        Swal.fire("ত্রুটি!", "অ্যাম্বুলেন্স তথ্য লোড করতে সমস্যা হয়েছে।", "error");
      } finally {
        setFetching(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await axiosSecure.put(`/ambulances/${id}`, formData);
      if (res.data.modifiedCount > 0) {
        Swal.fire("সফল!", "অ্যাম্বুলেন্স তথ্য সফলভাবে আপডেট হয়েছে।", "success");
        navigate("/dashboard/adminAmbulance");
      }
    } catch (error) {
      Swal.fire("ত্রুটি!", "অ্যাম্বুলেন্স আপডেট করতে সমস্যা হয়েছে।", "error");
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex justify-center items-center">
        <div className="text-center">
          ...
          <p className="text-blue-600 font-semibold text-xl">তথ্য লোড হচ্ছে...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
            অ্যাম্বুলেন্স তথ্য সম্পাদনা করুন
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            বিদ্যমান অ্যাম্বুলেন্স সার্ভিসের তথ্য আপডেট করুন
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-6 text-white">
            <h2 className="text-2xl font-bold flex items-center">
              ...
              অ্যাম্বুলেন্স তথ্য সম্পাদনা
            </h2>
            <p className="text-blue-100 mt-2">প্রয়োজনীয় তথ্য পরিবর্তন করুন</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8">
                ...
                {formData.imageUrl && (
                  <div className="mt-4 text-center">
                    <img
                      ...
                      alt="Current"
                      className="mx-auto w-48 h-32 object-cover rounded-xl shadow-lg border-4 border-blue-200"
                    />
                    <p className="text-blue-600 mt-2 flex items-center justify-center">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                } text-white font-bold px-8 py-4 rounded-xl transition-all duration-300 text-lg shadow-lg flex items-center justify-center`}
              >
                {loading ? (
                  <>
              ...
              <button
                type="button"
                onClick={() => navigate("/dashboard/adminAmbulance")}
                className="bg-gradient-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700 text-white font-bold px-8 py-4 rounded-xl transition-all duration-300 text-lg shadow-lg transform hover:scale-105 flex items-center justify-center"
              >
        ...
        <div className="mt-8 text-center p-6 bg-white rounded-xl shadow-lg border border-gray-100">
          <p className="text-gray-600 text-sm">
            <span className="font-semibold text-blue-600">দ্রষ্টব্য:</span> শুধুমাত্র প্রয়োজনীয় তথ্য পরিবর্তন করুন। 
            ভুল তথ্য পরিবর্তন করলে সার্ভিসে সমস্যা হতে পারে।
          </p>
        </div>
      </div>
    </div>
