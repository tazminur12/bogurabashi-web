...
import { FiZap, FiSave, FiArrowLeft, FiMapPin, FiPhone, FiType, FiFileText, FiGlobe, FiLoader } from 'react-icons/fi';
...
const EditElectricity = () => {
  ...
  useEffect(() => {
    const fetchElectricity = async () => {
      try {
        ...
        const res = await axiosSecure.get(`/electricities/${id}`);
        if (res.data.success) {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await axiosSecure.put(`/electricities/${id}`, formData);
      
      if (res.data.success) {
        Swal.fire({
          title: 'সফল!',
          text: 'বগুড়া জেলার বিদ্যুৎ কেন্দ্র সফলভাবে আপডেট করা হয়েছে',
          icon: 'success',
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-gray-800">বগুড়া জেলার বিদ্যুৎ কেন্দ্র সম্পাদনা করুন</h1>
                  <p className="text-gray-600 mt-1">বিদ্যুৎ কেন্দ্রের তথ্য আপডেট করুন</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
              ...
              >
                ...
                {loading ? 'আপডেট হচ্ছে...' : 'বিদ্যুৎ কেন্দ্র আপডেট করুন'}
              </button>
