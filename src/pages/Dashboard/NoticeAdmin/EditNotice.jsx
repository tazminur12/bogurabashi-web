...
import { FaArrowLeft, FaSave, FaTimes, FaBell, FaCalendarAlt, FaFileAlt, FaSpinner } from "react-icons/fa";
...
const EditNotice = () => {
  ...
  useEffect(() => {
    const fetchNotice = async () => {
      try {
        ...
        setValue("publishDate", res.data.publishDate ? res.data.publishDate.slice(0, 10) : "");
      } catch (error) {
        console.error("নোটিশ লোড করতে সমস্যা হয়েছে:", error);
        Swal.fire("ত্রুটি!", "নোটিশ লোড করতে সমস্যা হয়েছে!", "error").then(() => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await axiosSecure.patch(`/notices/${id}`, data);
      
      Swal.fire({
        title: "সফল!",
        text: "নোটিশ সফলভাবে আপডেট করা হয়েছে!",
        icon: "success",
      ...
      console.error("নোটিশ আপডেট করতে সমস্যা হয়েছে:", error);
      Swal.fire("ত্রুটি!", "নোটিশ আপডেট করতে সমস্যা হয়েছে!", "error");
    } finally {
  ...
  if (!notice) {
    return (
      <div className="text-center py-12">
        <h3 className="text-lg font-medium text-gray-600 mb-2">নোটিশ পাওয়া যায়নি</h3>
        <button
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">নোটিশ সম্পাদনা করুন</h1>
              <p className="text-gray-600 mt-1">নোটিশের তথ্য আপডেট করুন</p>
            </div>
          </div>
      ...
      <div className="bg-blue-50 rounded-lg border border-blue-200 p-4 mb-6">
        <h3 className="text-sm font-medium text-blue-800 mb-2">বর্তমান নোটিশ</h3>
        <p className="text-blue-700 text-sm">
          <strong>শিরোনাম:</strong> {notice.title}
        </p>
        <p className="text-blue-700 text-sm">
          <strong>প্রকাশের তারিখ:</strong> {notice.publishDate ? new Date(notice.publishDate).toLocaleDateString('bn-BD') : 'তারিখ উল্লেখ নেই'}
        </p>
      </div>
