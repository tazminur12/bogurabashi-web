...
import { FiPackage, FiMapPin, FiPhone, FiUser, FiGlobe, FiSave, FiArrowLeft, FiInfo, FiEdit } from "react-icons/fi";
...
const EditCourierService = () => {
  ...
  useEffect(() => {
    const fetchCourier = async () => {
      try {
        setIsFetching(true);
        const res = await axiosSecure.get(`/couriers/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axiosSecure.put(`/couriers/${id}`, courierData);
      
      if (res.data.modifiedCount > 0) {
        Swal.fire({
          title: "সফল!",
          text: "কুরিয়ার সার্ভিস সফলভাবে আপডেট করা হয়েছে",
          icon: "success",
      ...
      Swal.fire("ত্রুটি", "কুরিয়ার আপডেট করা যায়নি", "error");
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-2">কুরিয়ার সার্ভিস সম্পাদনা করুন</h1>
          <p className="text-gray-600 text-lg">কুরিয়ার সার্ভিসের তথ্য আপডেট করুন</p>
        </div>
