...
const AddAd = ({ onClose, onSuccess }) => {
  ...
  const addAdMutation = useMutation({
    ...
    onError: (error) => {
      ...
      Swal.fire({
        icon: 'error',
        title: 'বিজ্ঞাপন যোগ করতে সমস্যা হয়েছে',
  ...
  const handleImageUpload = async (e) => {
    ...
    if (file.size > 5 * 1024 * 1024) {
      Swal.fire({
        icon: 'error',
        title: 'ফাইলের আকার খুব বড়',
        text: 'ছবির আকার 5MB এর কম হতে হবে',
        showConfirmButton: true,
      });
      return;
    }
    ...
    try {
      ...
      if (!imgbbApiKey) {
        Swal.fire({
          icon: 'error',
          title: 'API Key পাওয়া যায়নি',
          text: 'ImgBB API key পাওয়া যায়নি। ছবি আপলোড করা যাবে না।',
          showConfirmButton: true,
        });
      ...
      if (result.success) {
        ...
        Swal.fire({
          ...
          text: 'ছবি আপলোড করতে সমস্যা হয়েছে। দয়া করে আবার চেষ্টা করুন।',
          showConfirmButton: true,
        });
      }
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.title.trim()) {
      Swal.fire({
        ...
        text: 'দয়া করে বিজ্ঞাপনের শিরোনাম লিখুন',
        showConfirmButton: true,
      });
      return;
    }
    ...
    if (!formData.description.trim()) {
      Swal.fire({
        ...
        text: 'দয়া করে বিজ্ঞাপনের বিবরণ লিখুন',
        showConfirmButton: true,
      });
      return;
    }
    ...
    if (!formData.category.trim()) {
      Swal.fire({
        icon: 'warning',
        title: 'বিভাগ প্রয়োজন',
        text: 'দয়া করে বিজ্ঞাপনের বিভাগ নির্বাচন করুন',
        showConfirmButton: true,
      });
      return;
    }
    ...
    addAdMutation.mutate(submitData);
  };
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900">নতুন বিজ্ঞাপন যোগ করুন</h2>
          </div>
          <button
            onClick={onClose}
