...
const EditBlog = () => {
  ...
  useEffect(() => {
    const fetchBlog = async () => {
      try {
        ...
        Swal.fire("❌ ত্রুটি", "ব্লগ লোড করতে সমস্যা হয়েছে", "error");
        navigate("/dashboard/blogs-admin");
      } finally {
        setFetching(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axiosSecure.put(`/blogs/${id}`, payload);

      Swal.fire({
        title: "✅ সফল!",
        text: "ব্লগ আপডেট হয়েছে",
        icon: "success",
      ...
      Swal.fire("❌ ত্রুটি", "ব্লগ আপডেট করতে সমস্যা হয়েছে", "error");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <button
                onClick={() => navigate("/dashboard/blogs-admin")}
                className="p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors"
              >
                <FaArrowLeft className="w-5 h-5" />
              </button>
              <div>
                <h1 className="text-2xl font-bold text-gray-900">ব্লগ সম্পাদনা করুন</h1>
                <p className="text-sm text-gray-600">আপনার ব্লগ পোস্ট আপডেট করুন</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">গুরুত্বপূর্ণ নোট</h3>
              <div className="mt-2 text-sm text-blue-700">
                <p>• ImgBB API কী সেট করতে হবে। আপনার ImgBB API কী <code className="bg-blue-100 px-1 rounded">IMGBB_API_KEY</code> ভেরিয়েবলে সেট করুন।</p>
                <p>• ছবি আপলোডের জন্য ImgBB ফ্রি অ্যাকাউন্ট প্রয়োজন।</p>
              </div>
            </div>
          </div>
        </div>
